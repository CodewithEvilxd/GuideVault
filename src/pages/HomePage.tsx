      ...
      <ClickSpark>
        <section className="pt-20 pb-16 md:pt-32 md:pb-20">
          ...
          <motion.p
            ...
            className="text-center text-[hsl(var(--muted-foreground))] text-lg mt-6 max-w-2xl mx-auto"
          >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ArrowRight className="h-3 w-3 text-[hsl(var(--muted-foreground))] opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 shrink-0" />
                </Link>
              </motion.div>
            );
          })}
